...
const { getAllProducts, getAllProductsAdmin , getProductById, getAuctioneerBoardByProductId, addProduct, updateProduct, deleteProduct, addProductImage, deleteProductImage, filterSearchProduct, getUserAuct, addAuctioneerBoard } = require('../controllers/productController');
...
router.get('/auctioneer/:product_id', getAuctioneerBoardByProductId);
