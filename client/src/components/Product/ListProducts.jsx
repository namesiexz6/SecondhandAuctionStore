              ...
              <div className="flex flex-col">
                ...
                <div className="flex flex-row justify-between items-top w-full mt-2">
                  <div className="flex flex-col flex-1">
                    ...
                    <span className="text-[10px] sm:text-sm  text-blue-600 mt-1">{product.starting_price.toLocaleString()} ฿</span>
                  </div>
                ...
                <div className="flex flex-row justify-between items-top w-full mb-2">
                  <div className="flex flex-col flex-1">
                    <span className="text-[10px] sm:text-xs text-gray-500 font-sans">Minimum Bid:</span>
                    <span className="text-[10px] sm:text-sm text-blue-600 mt-1">{product.min_bid_price.toLocaleString()} ฿</span>
                  </div>
                  <div className="flex flex-col items-end flex-1">
                    <span className="text-[10px] sm:text-xs text-gray-500">Current bid:</span>
                    <span className="text-base sm:text-lg font-semibold text-green-600">{product.auctioneerBoards && product.auctioneerBoards.length > 0 ? `${product.auctioneerBoards[0].price_offer.toLocaleString()} ฿` : '--//--'}</span>
                  </div>
                </div>
              </div>
            </div>
